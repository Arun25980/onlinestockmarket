                                    ...
                                    while($res1=mysql_fetch_row($res)){
                                     ?>
                                        <tr>
                                        	...
                                        	<td><? echo "".$res1[0];?></td>
                                        	<td><? echo "".$res1[2];?></td>                                  
                                        	<td><a href="adminremoveuser.php?email=<?echo "".$res1[2];?>" class="btn btn-danger">Remove User</a> <a href="adminsendmessagetousers.php?to=<?echo "".$res1[2];?>" class="btn btn-primary">Contact User</a></td>
                                        </tr>
                                        <?}?>
                                    </tbody>
                                </table>
