                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="admintousermsglogic.php" method="POST" onsubmit="msgalert()">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="touser" class="form-control" value="<?echo "".$to;?>" >
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card card-user" align="centre">
                            ...
                            <div class="content" align="centre">
                                <div class="author">
                                     <a href="#">
                                  <br/><br/><br/><br/>
                                      <h4 class="title">Sent Messages to users<br />
                                      </h4>
                                    </a>
                                </div>
                             	   <table class="table table-hover">									<thead>
										...
										<tbody>
											<?$query1=mysql_query("select *from adminsent");
											...
											<hr>
											<br>
									<a align="centre"href="deleteadminoutbox.php" class="btn btn-danger">Clear Outbox</a>
